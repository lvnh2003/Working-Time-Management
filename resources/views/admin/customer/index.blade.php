                    ...
                    <div class="card-content">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-group label-floating is-empty">
                                ...
                                <input name="name" type="text" class="form-control" name="email" autocomplete="off">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-group label-floating is-empty">
                                ...
                                <input name="email" type="email" class="form-control" name="email" autocomplete="off">
                                <span class="material-input"></span>
                            </div>
                        </div>
                        <div class="input-group">
                            ...
                            <div class="form-group label-floating is-empty">
                                ...
                                <input name="password" type="password" class="form-control" name="email"
                                    autocomplete="off">
                                <span class="material-input"></span>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            @if (session()->has('error'))
                demo.showNotification('top', 'right', 'danger', "{!! session()->get('error') !!}");
            @endif
